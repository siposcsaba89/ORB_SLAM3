...
class VertexSim3ExpmapGeomCam : public g2o::BaseVertex<7, g2o::Sim3>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    VertexSim3ExpmapGeomCam();
...
class EdgeSim3ProjectXYZ : public  g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, ORB_SLAM3::VertexSim3ExpmapGeomCam>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeSim3ProjectXYZ();
    ...
    void computeError()
    {
        const ORB_SLAM3::VertexSim3ExpmapGeomCam* v1 = static_cast<const ORB_SLAM3::VertexSim3ExpmapGeomCam*>(_vertices[1]);
        const g2o::VertexSBAPointXYZ* v2 = static_cast<const g2o::VertexSBAPointXYZ*>(_vertices[0]);
...
class EdgeInverseSim3ProjectXYZ : public  g2o::BaseBinaryEdge<2, Eigen::Vector2d,  g2o::VertexSBAPointXYZ, VertexSim3ExpmapGeomCam>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
