...
void Optimizer::FullInertialBA(Map *pMap, int its, const bool bFixLocal, const long unsigned int nLoopId, bool *pbStopFlag, bool bInit, float priorG, float priorA, Eigen::VectorXd *vSingVal, bool *bHess)
{
    ...
    linearSolver.reset( new g2o::LinearSolverEigen<g2o::BlockSolverX::PoseMatrixType>());
                            ...
                            const bool bFixScale, Eigen::Matrix<double,7,7> &mAcumHessian, const bool bAllPoints)
{
    ...
    // Set Sim3 vertex
    ORB_SLAM3::VertexSim3ExpmapGeomCam * vSim3 = new ORB_SLAM3::VertexSim3ExpmapGeomCam();
    vSim3->_fix_scale=bFixScale;
    vSim3->setEstimate(g2oS12);
    vSim3->setId(0);
    vSim3->setFixed(false);
                            ...
                            const bool bFixScale, Eigen::Matrix<double,7,7> &mAcumHessian, const bool bAllPoints)
{
    ...
    // Recover optimized Sim3
    ORB_SLAM3::VertexSim3ExpmapGeomCam* vSim3_recov = static_cast<ORB_SLAM3::VertexSim3ExpmapGeomCam*>(optimizer.vertex(0));
    g2oS12= vSim3_recov->estimate();
